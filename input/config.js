...
const description = "RugRatz Party.";
...
let rarityWeights = [
  ...
  // addRarity('rare', 1, 450),
  addRarity('original', 1, 4000)
];
...
// addRarityPercentForLayer('super_rare', '2-Body', { 'super_rare': 100, 'rare': 0, 'original': 0 });
// addRarityPercentForLayer('rare', '6-eyes', { 'super_rare': 0, 'rare': 100, 'original': 0 });
// addRarityPercentForLayer('original', '7-necklace', { 'super_rare': 0, 'rare': 0, 'original': 100 });
